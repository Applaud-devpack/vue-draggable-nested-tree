...
* [ie11 example](https://github.com/phphe/vue-draggable-nested-tree/tree/master/ie11-example)
...
# install
```sh
npm i @appalud/vue-draggable-nested-tree
```
<a name="usage"></a>
# usage
<a name="import"></a>
### import
```js
import {DraggableTree} from '@appalud/vue-draggable-nested-tree'
// @appalud/vue-draggable-nested-tree contains Tree, TreeNode, DraggableTree, DraggableTreeNode
